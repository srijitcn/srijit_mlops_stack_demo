...
# It is configured and can be executed as a training-job.tf job defined under ``srijit_mlops_stack_demo/terraform``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-srijit_mlops_stack_demo-experiment",
    label="MLflow experiment name",
)

# MLflow registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev-srijit_mlops_stack_demo-model", label="Model Name"
)
