...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``srijit_mlops_stack_demo/terraform``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in srijit_mlops_stack_demo/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in srijit_mlops_stack_demo/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-srijit_mlops_stack_demo-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev-srijit_mlops_stack_demo-model", "Model Name")
